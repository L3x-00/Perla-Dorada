-- ============================================================
-- admin_list_ticket_groups gana voided_count, para que /admin/tickets
-- pueda mostrar y seguir permitiendo imprimir el resto de un grupo que
-- tiene algunos tickets anulados (antes exigía activos == total).
-- ============================================================
...
comment on function public.admin_list_ticket_groups(
  ...
  is 'Lista grupos de tickets por solicitud y rifa con filtros, conteos (incluye anulados) y paginacion. Uso exclusivo del backend.';
